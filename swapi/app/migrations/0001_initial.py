# Generated by Django 2.2.13 on 2022-01-23 16:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hair_color', models.CharField(blank=True, choices=[('none', 'NONE'), ('brown', 'BROWN'), ('bald', 'BALD'), ('black', 'BLACK'), ('red', 'RED'), ('white', 'WHITE'), ('blonde', 'BLONDE')], max_length=32)),
                ('skin_color', models.CharField(blank=True, max_length=32)),
                ('eye_color', models.CharField(blank=True, choices=[('brown', 'BROWN'), ('blue', 'BLUE'), ('black', 'BLACK'), ('red', 'RED'), ('purple', 'PURPLE'), ('unknown', 'UNKNOWN'), ('white', 'WHITE'), ('yellow', 'YELLOW'), ('green', 'GREEN')], max_length=32)),
